...
def test_standard_tool_call_generation():
    ...
    print_comparison("Standard Tool Call", xml_out, json_out, md_out)
...
def test_multiple_tool_calls():
    ...
    print_comparison("Multiple Tool Calls", xml_out, json_out, md_out)
...
def test_complex_arguments():
    ...
    print_comparison("Complex Arguments", xml_out, json_out, md_out)
...
def test_edge_cases():
    ...
    print_comparison("No Arguments", no_args_xml, no_args_json, no_args_md)
